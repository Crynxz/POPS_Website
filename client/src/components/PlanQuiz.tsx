                    ...
                    {currentStep.id === 'result' && (
                        <div className="text-center">
                            <div className="p-6 rounded-3xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 relative overflow-hidden">
                                ...
                                <div className="bg-white/60 rounded-xl py-3 border border-blue-100/50 mb-6 mx-4">
                                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1">Intervalo de Mercado</span>
                                    <div className="flex items-baseline justify-center gap-1">
                                        <span className="text-3xl font-black text-blue-700">{recommendedPlan.price}</span>
