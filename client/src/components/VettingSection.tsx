...
export default function VettingSection() {
  ...
  return (
    <section className="py-24 md:py-32 bg-gradient-to-b from-slate-50/50 to-white relative overflow-hidden" id="seguranca">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-red-50/40 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 hidden md:block"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-primary/3 rounded-full blur-3xl translate-x-1/2 translate-y-1/2 hidden md:block"></div>
