...
export function PartnersSection() {
  ...
  return (
    <section className="partners-preview py-20 bg-slate-50 border-t border-slate-200 relative overflow-hidden transition-colors duration-300">
        ...
        <div className="container mx-auto px-6 relative z-10">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                ...
                <Link href="/parceiros">
                    <a className="inline-flex items-center gap-2 px-6 py-3 bg-white text-slate-700 border border-slate-200 rounded-xl font-semibold hover:border-primary/50 hover:text-primary hover:shadow-md transition-all group">
