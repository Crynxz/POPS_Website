  ...
  const services = [
    {
      ...
      features: t("service.senior.features").split(","),
      color: "bg-primary",
    ...
    },
    {
      ...
      features: t("service.inclusion.features").split(","),
      color: "bg-orange-500",
    ...
    },
    {
      ...
      features: t("service.health.features").split(","),
      color: "bg-blue-500",
    ...
    },
    {
      ...
      features: t("service.domestic.features").split(","),
      color: "bg-purple-500",
