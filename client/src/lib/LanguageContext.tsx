...
const translations = {
  PT: {
    ...
    "cta.caregiver": "Sou Profissional",
    "cta.family": "Sou Família",

    // Hero
      "hero.badge": "Plataforma Certificada em Portugal",
      "hero.title.1": "Apoio Domiciliário Líder",
      "hero.title.2": "com Confiança e Tecnologia.",
      "hero.desc": "A POPS é o intermediário oficial de serviços ao domicílio em Portugal. Conectamos famílias a cuidadores certificados e auxiliares de geriatria verificados criminalmente, garantindo o descanso do cuidador e o bem-estar familiar.",
    "hero.cta.find": "Procurar Cuidador",
    "hero.cta.work": "Trabalhar na POPS",
    "hero.trust.1": "Certificações Validadas SNS/SS",
    "hero.trust.2": "Controlo GPS em Tempo Real",
    "hero.trust.3": "Faturação e Benefícios Fiscais",
